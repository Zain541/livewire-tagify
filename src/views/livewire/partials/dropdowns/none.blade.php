...
<div x-ref="panel"
    ...
    <div class="tagify__dropdown__wrapper">
        <button type="button"
                ...
                style="display: flex; align-items: center; gap: 8px; width: 100%; text-align: left; border: none; background: transparent; cursor: pointer;">
        ...
        <div style="height: 1px; background: rgba(0,0,0,0.06); margin: 6px 0;" role="separator"></div>

        <div style="padding: 10px 14px;">
            <p class="livewire-tagify__section-label" id="tagify-color-label-none">
                Label Color
            </p>

            <div class="livewire-tagify__color-list" role="listbox" aria-labelledby="tagify-color-label-none">
